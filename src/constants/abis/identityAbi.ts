export const identityAbi = [
  {
    inputs: [
      ...
      { internalType: "bool", name: "_isLibrary", type: "bool" },
    ],
  ...
  },
  {
    ...
    name: "ClaimNotRegistered",
    type: "error",
  },
  { inputs: [], name: "InitialKeyAlreadySetup", type: "error" },
  {
    inputs: [],
    name: "InteractingWithLibraryContractForbidden",
    type: "error",
  },
  ...
  { inputs: [], name: "SenderDoesNotHaveActionKey", type: "error" },
  { inputs: [], name: "SenderDoesNotHaveClaimSignerKey", type: "error" },
  { inputs: [], name: "SenderDoesNotHaveManagementKey", type: "error" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "_shouldApprove", type: "bool" },
    ],
    name: "approve",
    outputs: [{ internalType: "bool", name: "success", type: "bool" }],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_executionId", type: "uint256" },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct Structs.Execution",
        name: "execution",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    name: "getKeyPurposes",
    outputs: [
      { internalType: "uint256[]", name: "_purposes", type: "uint256[]" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "isClaimValid",
    outputs: [{ internalType: "bool", name: "claimValid", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  {
